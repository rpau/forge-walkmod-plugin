== walkmod
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The walkmod addon enables blah blah...)
...
----
<dependency>
   <groupId>org.walkmod.forge.addon</groupId>
