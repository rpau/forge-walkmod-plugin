...
:idprefix: id_ 
The forge addon enables to run http://www.walkmod.com [Walkmod] commands (install, apply and check) from Forge, create a Walkmod plugin skeleton and initilize a Java project with a simple Walkmod configuration file. 
